                                            ...
                                            <div className="col-xl-4 col-lg-5 col-md-6">
                                                <div className="contact-info-list">
                                                    ...
                                                    <div className="lats-chat">
                                                        <Link href="/contact">Lat’s Chat</Link>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-xl-8 col-lg-7 col-md-6">
                                                <div className="our-best-project">
                                                    <div className="content">
                                                        ...
                                                        <Link href="/project-details" className="btn">Details <span /></Link>
                                                    </div>
                                                    <div className="thumb">
                                    ...
                                    <div className="customer-support-wrap">
                                        ...
                                        <div className="customer-support-content">
                                            ...
                                            <p>We offer solutions for businesses of all sizes. For questions about our plans and products,,
                                                contact our team of experts. <Link href="/contact">Get in touch</Link></p>
                                        </div>
